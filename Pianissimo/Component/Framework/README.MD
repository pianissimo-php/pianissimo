...
### Controller resolver
After the container has been booted in the `handle()` method, the controller resolver is called.
...
The `RouterControllerCompilerPass` which adds a method call, is used to load the routes.
